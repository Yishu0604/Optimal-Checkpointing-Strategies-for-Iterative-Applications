...
for i_total=1:5
    clearvars -except n P_total i_total p_save ratio k_star_total p_opt_pattern_total type time%p_save
    P=P_total(i_total)
    repeat_times=100;
...
eval(['save data_random_n' num2str(n) '_type' num2str(type) '.mat n k_star_total p_opt_pattern_total ratio time'])
tt=toc