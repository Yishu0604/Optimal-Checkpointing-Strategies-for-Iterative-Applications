...
%     ratio6 = MS_YD_C_min./ MS_opt_pattern;
    ...
    ratio1 = MS_each_segement/MS_baseline;
    ratio2 = MS_p_YD/MS_baseline;
    ratio3 = MS_each_iteration/MS_baseline;
%     ratio4 = MS_YD_C_max/ MS_baseline;
    ratio5 = MS_YD_C_mean/ MS_baseline;
%     ratio6 = MS_YD_C_min/ MS_baseline;
    ratio7 = MS_opt_pattern/MS_baseline;
    
%     ratio(1+(i_total-1)*repeat_times*7:i_total*repeat_times*7,1) = [ratio1'; ratio2'; ratio3'; ratio4'; ratio5'; ratio6'; ratio7'];
 ratio(1+(i_total-1)*repeat_times*5:i_total*repeat_times*5,1) = [ratio1'; ratio2'; ratio3'; ratio5'; ratio7'];
    
    k_star_total(i_total)= k_star;
    p_opt_pattern_total(i_total)= p_opt_pattern;
end
csvwrite('data_gopi_base_temp.csv',ratio,1,0)
%csvwrite('data_gopi.csv',ratio,1,0)
save data_gopi_base.mat n k_star_total p_opt_pattern_total ratio time