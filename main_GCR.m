...
for i_total=1:5
    clearvars -except CCR P_total i_total t T C R D n ratio k_star_total p_opt_pattern_total time %p_save
    P=P_total(i_total)
    repeat_times=100;
...
eval(['save data_GCR_n' num2str(n) '_CCR' num2str(CCR) '.mat n k_star_total p_opt_pattern_total ratio time'])
