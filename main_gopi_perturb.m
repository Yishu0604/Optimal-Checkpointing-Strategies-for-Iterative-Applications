...
%     MS_YD_C_min=zeros(1,repeat_times);
    ...
    for i_rep=1:repeat_times  
        ...
        MS_opt_pattern(i_rep) = simulation_optimal_pattern_perturb(N,F(i_rep,:),t,C,C_pattern,R_pattern,D,k_seg,n,w_length,i_w); %Ckpt optiaml
...
csvwrite('data_gopi_perturb_temp.csv',ratio,1,0)
%csvwrite('data_gopi.csv',ratio,1,0)
save data_gopi_perturb.mat n k_star_total p_opt_pattern_total ratio time
