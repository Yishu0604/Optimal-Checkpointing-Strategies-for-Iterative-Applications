...
for i_total=1:5
    clearvars -except n P_total i_total t T C R D ratio k_star_total p_opt_pattern_total time barplot_data_total%p_save
    P = P_total(i_total)
...
%csvwrite('data_gopi_temp.csv',ratio,1,0)
%csvwrite('data_gopi.csv',ratio,1,0)
%save data_gopi.mat n k_star_total p_opt_pattern_total ratio time
...
save data_gopi.mat n k_star_total p_opt_pattern_total ratio time ratio_median barplot_data_total
